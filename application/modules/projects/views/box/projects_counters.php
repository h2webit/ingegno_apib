...
<div class="col-sm-12">
    <div class="small-box" style="background-color: <?php echo $status['projects_status_color'] ?? '#4b4b4b'; ?>; color: white;">
        ...
        <a href="<?php echo base_url('projects/main/filter_project_status/' . $status['projects_status_id'].'/projects'); ?>" class="small-box-footer"><?php e('Filter'); ?> <i class="fa fa-arrow-circle-right"></i></a>
    </div>
</div>
<!-- </div> -->
<?php
