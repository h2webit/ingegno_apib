   ...
   <div class="col-sm-12">
      ...
      <table class="table table-striped">
         <?php if ($contabilita_installato == DB_BOOL_TRUE): ?>
            ...
            <?php
            $ordini = $this->apilib->search('documenti_contabilita_commesse', ['documenti_contabilita_commesse_projects_id' => $value_id, 'documenti_contabilita_tipo =' => 5]);
            if (!$ordini):
               ...
               foreach ($ordini as $ordine):
                  ...
                  if (!empty($documento_contabilita)):
                     ...
                     foreach ($articoli_ordine_cliente as $articolo_ordine):
                        ...
                        ?>
                        <tr>
                           <td colspan="4" style="background:color:red;padding-left:50px;"><?php echo $i . ") "; ?>
                              <?php echo number_format($articolo_ordine['documenti_contabilita_articoli_quantita'], 0, '.', '.') . " x " . $articolo_ordine['documenti_contabilita_articoli_name']; ?></strong>
                           </td>
                           <td><?php echo $default_currency . " " . number_format($prezzo_no_ivato, 2, '.', '.');
                           ; ?></td>
                        </tr>
                        <?php
                     endforeach;
         ...
         if (!empty($ordini_fornitori)):
            ...
            foreach ($ordini_fornitori as $ordine_fornitore):
               ...
               <tr>
                  <td colspan="4">
                     <strong><?php echo $documento['documenti_contabilita_tipo_value'] . " " . $documento['documenti_contabilita_numero']; ?>
                        del <?php echo dateFormat($documento['documenti_contabilita_data_emissione']); ?></strong>
                  </td>
                  <td class="text-red">
                     <strong><?php echo $default_currency . " " . $documento['documenti_contabilita_competenze']; ?></strong>
                  </td>
               </tr>
               <?php
               if (isset($documento)):
            ...
            <tr>
               ...
               <td class="<?php echo ($total_balance > 0) ? 'text-green' : 'text-red' ?>">
                  <strong><?php echo $default_currency; ?><?php echo $total_balance; ?></strong>
               </td>
            </tr>
            <tr>
               <td colspan="4"><strong><?php e('Expected profit'); ?></strong></td>
               <td class="<?php echo ($margin_balance > 0) ? 'text-green' : 'text-red' ?>">
                  <strong><?php echo number_format($margin_balance, 2, '.', '.'); ?>%</strong>
               </td>
            </tr>
            <?php
         endif;
   ...
   <div class="col-sm-12">
      ...
      <table class="table table-striped">
         <?php if ($contabilita_installato == DB_BOOL_TRUE): ?>
            ...
            <?php
            $ordini = $this->apilib->search('documenti_contabilita_commesse', ['documenti_contabilita_commesse_projects_id' => $value_id, 'documenti_contabilita_tipo IN (1,4)']);
            if (!$ordini):
               $label_vendita = "Prezzo di vendita";
               $prezzo_vendita_totale = $project['projects_sold_price'];
               ?>
            ...
            ?>
            <tr>
               <td colspan="4" class="text-green"><strong>Totale Fatture</strong></td>
               <td class="text-green"><strong><?php echo $default_currency . " " . $prezzo_vendita_totale; ?></strong></td>
            </tr>
            <?php
         endif;
...
<div class="row">
   <div class="col-sm-12">
      ...
      <table class="table table-striped">
         ...
         <tr>
            <td>
               <?php echo $label_vendita; ?>
            </td>
            <td class="text-red"><strong>
                  <?php echo $default_currency . " " . $prezzo_vendita; ?>
               </strong></td>
         </tr>
         <?php
               if (isset($documento_contabilita)):
                  ...
                  foreach ($articoli_ordine_cliente as $articolo_ordine):
                     ...
                     ?>
         <tr>
            <td style="background:color:red;padding-left:50px;">
               <?php echo $i . ") "; ?>
               <?php echo number_format($articolo_ordine['documenti_contabilita_articoli_quantita'], 0, '.', '.') . " x " . $articolo_ordine['documenti_contabilita_articoli_name']; ?></strong>
            </td>
            <td>
               <?php echo $default_currency . " " . number_format($prezzo_no_ivato, 2, '.', '.'); ?>
            </td>
         </tr>
         <?php
                  endforeach;
         ...
         <tr>
            ...
            <td class="text-red">
               <strong>
                  <?php echo $default_currency . " " . number_format($totale_ordini_interni, 2, '.', '.'); ?>
               </strong>
            </td>
         </tr>
         <?php
   ...
   <div class="col-sm-12">
      <table class="table table-striped">
         ...
         <tr>
            ...
            <td colspan="1" class="text-green">
               <strong>
                  <?php echo floor($hours) == $hours ? number_format($hours, 0, '.', ',') : number_format($hours, 2, '.', ','); ?>
                  <?php $hours > 1 ? e('hours') : e('hour') ?>
               </strong>
            </td>
            <td class="text-green"><strong>
                  <?php echo $ore_lavorate_tickets_report; ?>
                  <?php $ore_lavorate_tickets_report > 1 ? e('hours') : e('hour') ?>
               </strong></td>
            <td class="text-green">
               <strong>
                  <?php echo $default_currency . " " . $euro_fatturate_tickets_report; ?>
               </strong>
            </td>
            <td class="text-red"><strong>
                  <?php echo $default_currency . " " . $costo_interventi; ?>
               </strong></td>
            <td
               class="<?php echo (($euro_fatturate_tickets_report - $costo_interventi) > 0) ? 'text-green' : 'text-red' ?>">
               <strong>
                  <?php echo $default_currency . " " . ($euro_fatturate_tickets_report - $costo_interventi); ?>
               </strong>
            </td>
         </tr>
         <?php
         ...
         <tr>
            ...
            <td>
               <?php echo floor($ticket_report['ore_lavorate']) == $ticket_report['ore_lavorate'] ? number_format($ticket_report['ore_lavorate'], 0, '.', ',') : number_format($ticket_report['ore_lavorate'], 2, '.', ','); ?>
               <?php $ticket_report['ore_lavorate'] > 1 ? e('hours') : e('hour') ?>
            </td>
            <td>
               <?php echo floor($ticket_report['ore_fatturate']) == $ticket_report['ore_fatturate'] ? number_format($ticket_report['ore_fatturate'], 0, '.', '') : number_format($ticket_report['ore_fatturate'], 2, '.', ''); ?>
               <?php $ticket_report['ore_fatturate'] > 1 ? e('hours') : e('hour') ?>
            </td>
            <td>
               <?php echo $default_currency; ?>
               <?php echo $ticket_report['euro_fatturati']; ?>
            </td>
            <td>
               <?php echo $default_currency; ?>
               <?php echo $ticket_report['costo_interno']; ?>
            </td>
            <td>
               <?php echo $default_currency; ?>
               <?php echo $ticket_report['totale']; ?>
            </td>
         </tr>
         <?php
         endforeach;
         ...
         if (!empty($rapportini_commessa)):
            ...
            <tr>
               ...
               <td colspan="3" lass="text-green">
                  <strong><?php echo floor($ore_rapportini) == $ore_rapportini ? number_format($ore_rapportini, 0, '.', ',') : number_format($ore_rapportini, 2, '.', ','); ?>
                     <?php $ore_rapportini > 1 ? e('hours') : e('hour') ?></strong>
               </td>
            ...
            foreach ($rapportini_commessa as $rapportino):
               ...
               <tr>
                  ...
                  <td colspan="3" lass="text-green">
                     <?php echo floor($hours_lavorate) == $hours_lavorate ? number_format($hours_lavorate, 0, '.', ',') : number_format($hours_lavorate, 2, '.', ','); ?>
                     <?php $hours_lavorate > 1 ? e('hours') : e('hour') ?>
                  </td>
         ...
         if ($worked_hours_detail):
            ...
            <tr>
               ...
               <td colspan="3" class="text-red">
                  <strong><?php echo floor($worked_hours) == $worked_hours ? number_format($worked_hours, 0, '.', ',') : number_format($worked_hours, 2, '.', ','); ?>
                     <?php $worked_hours > 1 ? e('hours') : e('hour') ?></strong>
               </td>
               <td class="text-red">
                  <strong><?php echo $default_currency; ?><?php echo floor($worked_hours_cost) == $worked_hours_cost ? number_format($worked_hours_cost, 0, '.', ',') : number_format($worked_hours_cost, 2, '.', ','); ?></strong>
               </td>
               <td class="text-red">
                  <strong><?php echo $default_currency; ?><?php echo floor($worked_hours_cost) == $worked_hours_cost ? number_format($worked_hours_cost, 0, '.', ',') : number_format($worked_hours_cost, 2, '.', ','); ?></strong>
               </td>
            ...
            foreach ($worked_hours_detail as $ora_lavorata):
               ...
               <tr>
                  <td style="padding-left:50px;">
                     <?php echo $i . ") "; ?>
                     <?php echo $utente['users_last_name'] . " " . substr($utente['users_first_name'], 0, 1) . " - " . dateFormat($ora_lavorata['timesheet_start_time']); ?></strong>
                  </td>
                  <td colspan="3">
                     <?php echo floor($ora_lavorata['timesheet_total_hours']) == $ora_lavorata['timesheet_total_hours'] ? number_format($ora_lavorata['timesheet_total_hours'], 0, '.', ',') : number_format($ora_lavorata['timesheet_total_hours'], 2, '.', ','); ?>
                     <?php $ora_lavorata['timesheet_total_hours'] > 1 ? e('hours') : e('hour') ?>
                  </td>
                  <td>
                     <?php echo $default_currency; ?>
                     <?php echo floor($ora_lavorata['timesheet_total_cost']) == $ora_lavorata['timesheet_total_cost'] ? number_format($ora_lavorata['timesheet_total_cost'], 0, '.', ',') : number_format($ora_lavorata['timesheet_total_cost'], 2, '.', ','); ?>
                  </td>
                  <td>
                     <?php echo $default_currency; ?>
                     <?php echo floor($ora_lavorata['timesheet_total_cost']) == $ora_lavorata['timesheet_total_cost'] ? number_format($ora_lavorata['timesheet_total_cost'], 0, '.', ',') : number_format($ora_lavorata['timesheet_total_cost'], 2, '.', ','); ?>
         ...
         if ($expenses_detail):
            ...
            <tr>
               ...
               <td class="text-red">
                  <strong><?php echo $default_currency . " " . number_format($expenses, 2, '.', '.'); ?></strong>
               </td>
            </tr>
            <?php
            $i = 0;
            foreach ($expenses_detail as $spesa):
               ...
               ?>
               <tr>
                  <td colspan="5" style="padding-left:50px;"><?php echo $i . ") "; ?>
                     <?php echo $spesa['expenses_description']; ?></strong>
                  </td>
            ...
            foreach ($tickets as $ticket):
               ...
               <tr>
                  <td colspan="6" style="padding-left:50px;">
                     <?php echo $i . ") Ticket #" . $ticket['tickets_id'] . " del " . dateFormat($ticket['tickets_creation_date']); ?>
                     <?php
               ...
               foreach ($reports as $ticket_report):
                  if ($tickets_reports[$ticket_report['tickets_reports_id']]):
                     ...
                     <tr>
                        ...
                        <td>
                           <?php echo floor($tickets_reports[$ticket_report['tickets_reports_id']]['ore_lavorate']) == $tickets_reports[$ticket_report['tickets_reports_id']]['ore_lavorate'] ? number_format($tickets_reports[$ticket_report['tickets_reports_id']]['ore_lavorate'], 0, '.', ',') : number_format($tickets_reports[$ticket_report['tickets_reports_id']]['ore_lavorate'], 2, '.', ','); ?>
                           <?php $tickets_reports[$ticket_report['tickets_reports_id']]['ore_lavorate'] > 1 ? e('hours') : e('hour') ?>
                        </td>
                        <td>
                           <?php echo floor($tickets_reports[$ticket_report['tickets_reports_id']]['ore_fatturate']) == $tickets_reports[$ticket_report['tickets_reports_id']]['ore_fatturate'] ? number_format($tickets_reports[$ticket_report['tickets_reports_id']]['ore_fatturate'], 0, '.', '') : number_format($tickets_reports[$ticket_report['tickets_reports_id']]['ore_fatturate'], 2, '.', ''); ?>
                           <?php $tickets_reports[$ticket_report['tickets_reports_id']]['ore_fatturate'] > 1 ? e('hours') : e('hour') ?>
                        </td>
                        <td>
                           <?php echo $default_currency; ?>
                           <?php echo $tickets_reports[$ticket_report['tickets_reports_id']]['euro_fatturati']; ?>
                        </td>
                        <td>
                           <?php echo $default_currency; ?>
                           <?php echo $tickets_reports[$ticket_report['tickets_reports_id']]['costo_interno']; ?>
                        </td>
                        <td><?php echo $default_currency; ?>
                           <?php echo $tickets_reports[$ticket_report['tickets_reports_id']]['totale']; ?>
                        </td>
                     </tr>
                     <?php
                  endif;
      ...
      <div class="col-sm-12">
         <table class="table table-striped">
               ...
               if ($billable[0] == 1):
                  ...
                  <tr>
                     <td colspan="1" style="padding-left:50px;">
                        <?php echo $i++ . ") "; ?>
                        <?php echo $tipologia_ore_value . " ( caricate il " . dateFormat($billable[3]) . " )"; ?></strong>
                     </td>
                     <td colspan="1" class="text-green">
                        <strong><?php echo floor($billable[2]) == $billable[2] ? number_format($billable[2], 0, '.', '') : number_format($billable[2], 2, '.', ''); ?>
                           <?php $billable[2] > 1 ? e('hours') : e('hour') ?></strong>
                     </td>
                     <td colspan="2" class="text-green"><strong><?php echo $default_currency; ?>
                           <?php echo floor($billable[1]) == $billable[1] ? number_format($billable[1], 0, '.', '') : number_format($billable[1], 2, '.', ''); ?></strong>
                     </td>
                     <td colspan="1" class="text-green"><strong><?php echo $default_currency; ?>
                           <?php echo floor($billable[1] * $billable[2]) == $billable[1] * $billable[2] ? number_format($billable[1] * $billable[2], 0, '.', '') : number_format($billable[1] * $billable[2], 2, '.', ''); ?></strong>
                     </td>
                  </tr>
                  <?php
               elseif ($billable[0] == 4):
                  ...
                  <tr>
                     ...
                     <td colspan="1" style="padding-left:50px;">
                        <?php echo $i++ . ") "; ?>
                        <?php echo $tipologia_ore_value . " ( " . $billable[7] . " #" . $billable[5] . " del " . dateFormat($billable[6]) . " )"; ?></strong>
                     </td>
                     <td colspan="2" class="text-red">
                        <strong><?php echo floor($billable[1]) == $billable[1] ? number_format($billable[1], 0, '.', '') : number_format($billable[1], 2, '.', ''); ?>
                           <?php $billable[1] < -1 ? e('hours') : e('hour') ?></strong>
                     </td>
            ...
            <tr>
               ...
               <td colspan="1" class="<?php echo $totale_ore_lavorate > 1 ? 'text-green' : 'text-red' ?>">
                  <strong><?php echo floor($totale_ore_lavorate) == $totale_ore_lavorate ? number_format($totale_ore_lavorate, 0, '.', '') : number_format($totale_ore_lavorate, 2, '.', ''); ?>
                     <?php $totale_ore_lavorate > 1 ? e('hours') : e('hour') ?> </strong>
               </td>
               <td colspan="1" class="text-green"><strong><?php echo $default_currency; ?>
                     <?php echo floor($totale_vendita_ore_fatturate) == $totale_vendita_ore_fatturate ? number_format($totale_vendita_ore_fatturate, 0, '.', '') : number_format($totale_vendita_ore_fatturate, 2, '.', ''); ?></strong>
               </td>
               <td colspan="1" class="text-red"><strong><?php echo $default_currency; ?>
                     <?php echo floor($costo_interno_totale) == $costo_interno_totale ? number_format($costo_interno_totale, 0, '.', '') : number_format($costo_interno_totale, 2, '.', ''); ?></strong>
               </td>
               <td colspan="1" class="<?php echo ($totale_ore_fatturate > 0) ? 'text-green' : 'text-red' ?>">
                  <strong><?php echo $default_currency; ?><?php echo floor($totale_ore_fatturate) == $totale_ore_fatturate ? number_format($totale_ore_fatturate, 0, '.', '') : number_format($totale_ore_fatturate, 2, '.', ''); ?></strong>
               </td>
            </tr>
         </table>
      </div>
