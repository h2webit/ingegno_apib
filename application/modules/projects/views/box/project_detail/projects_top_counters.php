...
<!--------- Ore rapportini ------------>
<?php if (!empty($ingegno_settings['enable_top_counters_rapportini_hours']) && $ingegno_settings['enable_top_counters_rapportini_hours'] == DB_BOOL_TRUE): ?>
    <?php $rapportini_hours = $this->projects->get_rapportini_hours($value_id); ?>
    <div class="col-xs-2">
        <div class="conteggi_info">
            <div class="conteggio_info">
                <span class="conteggio_label"><i class="fas fa-tools"></i> Ore rapportini</span>
            </div>
            <div class="conteggio_info">
                <span class="conteggio_counter blue">
                    <?php echo $rapportini_hours['lavorate']; ?> </span>
            </div>
        </div>
    </div>
    ...
    <!-- <div class="col-xs-2">
        <div class="conteggi_info">
            <div class="conteggio_info">
                <span class="conteggio_label"><i class="fas fa-euro-sign"></i> Ore rapportini</span>
            </div>
            <div class="conteggio_info">
                <span class="conteggio_counter blue">
                    <?php //e_money($interventi_hours['fatturate']); ?> </span>
