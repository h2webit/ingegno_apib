...
<form action="<?php echo base_url(); ?>main/layout/nuovo_documento?" method="POST" id="genera_documento">
    ...
    <input type="hidden" id="documenti_contabilita_articoli_ids" name="documenti_contabilita_articoli_ids" value="" />
...
<form action="<?php echo base_url(); ?>main/layout/nuovo_movimento?" method="POST" id="genera_movimento">
    ...
    <input type="hidden" id="mov_documenti_contabilita_articoli_ids" name="documenti_contabilita_articoli_ids" value="" />
    <input type="hidden" id="cl_bulk_action" name="bulk_action" value="" />
</form>
        ...
        $js_bulk_action.on('change', function () {
            ...
            if (chkbx_ids.length > 0) {
                if ($(this).val() == 'genera_documento') {
                    $('#documenti_contabilita_articoli_ids').val(JSON.stringify(chkbx_ids));
                    ...
                    $('#mov_documenti_contabilita_articoli_ids').val(JSON.stringify(chkbx_ids));
