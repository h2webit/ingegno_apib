...
<form style="display: hidden" action="<?php echo base_url(); ?>contabilita/documenti/downloadZip" method="POST"
    id="form_export_zip">
...
<form style="display: hidden" action="<?php echo base_url(); ?>contabilita/primanota/bulkRegistraFatture" method="POST"
    id="form_registra_prima_nota">
    <input type="hidden" id="form_registra_prima_nota_ids" name="ids" value="" />
    ...
    $(document).ready(function () {
        $('.js-bulk-action').each(function (index) {
            ...
            $(this).on('change', function () {
                ...
                if ($(this).val() == 'registra_prima_nota') {
                    $('#form_registra_prima_nota_ids').val(JSON.stringify(chkbx_ids));
                    if (chkbx_ids.length > 0) {
                        $('#form_registra_prima_nota').submit();
                    }
                }
            });
        });
