                                ...
                                if (!$destinatario) { //Se per qualche motivo il documento non è associato, stampo la ragione sociale direttamente dal sottoconto
                                    ...
                                    if ($prima_nota_dati) {
                                        ...
                                        if ($customer) {
                                            ...
                                            $destinatario['partita_iva'] = 'n/d';
                                        }
                                    }
                                }
                                //debug($registrazione,true);
                                echo (($destinatario) ? $destinatario['ragione_sociale'] : ''); ?>
                            </td>
                            <td class="text-center">
    ...
    <table class="table totali_documento ">
        ...
        <tbody>
            ...
            <?php foreach ($totali as $totale): ?>
                ...
                <tr>
                    <!-- Cod-->
                    <td>
                        <?php echo $totale['iva_codice_esterno']; ?>
                    </td>
                    <!-- Descrizione iva -->
                    <td style="text-align:left">
                        <?php echo $totale['iva_descrizione']; ?>
                    </td>
                    <!-- perc iva-->
                    <td>
        ...
        <tfoot class="t_foot_totali">
            <tr>
                ...
                <!-- split imponibile -->
                <td>
                    <?php e_money($totale_split_imponibile, '€ {number}'); ?>
                </td>
                <!-- split imposta -->
                <td>
                    <?php e_money($totale_split_imposta, '€ {number}'); ?>
                </td>
            </tr>
            <tr>
                <td colspan="6">
                    <h4>TOTALE IMPONIBILE: €
                        <?php e_money($imponibili); ?>
                    </h4>
                </td>
                <td colspan="6">
                    <h4>TOTALE IMPOSTA: €
        ...
        <tbody>
            ...
            <?php foreach ($totali_per_sezionale as $sezionale => $totale): ?>
                ...
                <tr>
                    ...
                    <td>
                        <strong>
                            <?php e_money($totale['imponibile'], '€ {number}'); ?>
                        </strong>
                    </td>
                    <!-- italia imposta-->
                    <td>
                        ...
                        <strong>
                            <?php e_money($totale['imposta'], '€ {number}'); ?>
                        </strong>
