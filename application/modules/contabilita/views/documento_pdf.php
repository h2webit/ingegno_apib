                        ...
                        <div class="table-responsive-sm table_articoli">
                                    ...
                                    if (!empty($articolo['documenti_contabilita_articoli_name'])): ?>
                                        ...
                                        <tr class="t_rows">
                                            ...
                                            <td class="right">
                                                ...
                                                <?php echo ($articolo['documenti_contabilita_articoli_sconto'] > 0) ? "<br /><small>Sconto " . number_format((float) $articolo['documenti_contabilita_articoli_sconto'], 2, '.', '') . '% </small>' : ''; ?>
                                            </td>
                            ...
                            if (!empty($documento['documenti_contabilita_imponibile_iva_json'])) :
                                foreach (json_decode($documento['documenti_contabilita_imponibile_iva_json']) as $id_iva => $foo) : ?>
                                    ...
                                    <tr>
                                        ...
                                        <td></td>
                                        <td></td>
                                        <td class="right" colspan="3">IVA <?php echo $percentuale; ?>%</td>
                            ...
                            ?>
                                ...
                                <?php endif; ?>
                                                        ...
                                                        <?php
                                                        $esenzioni = false;
                                                        //debug($documento['documenti_contabilita_importo_bollo']);
                                                        if ($documento['documenti_contabilita_importo_bollo'] > 0) {
                                                            $esenzioni = true;
                                                        }                                                        
                                                        foreach ($iva as $i) {
                                                            //debug($i);
