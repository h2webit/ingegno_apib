...
<ImportoTotaleDocumento><?php if ($dati['fattura']['documenti_contabilita_split_payment'] == DB_BOOL_TRUE): ?><?php echo number_format($fattura_totale + $dati['fattura']['documenti_contabilita_iva'], 2, '.', ''); ?>
                    <?php else: ?><?php echo number_format($fattura_totale, 2, '.', ''); ?>
                    <?php endif;?></ImportoTotaleDocumento>
...
<CodiceValore></CodiceValore>
                    ...
                    <Descrizione><?php echo substr(str_replace(['&', '€'], ['&amp;', '&euro;'], $articolo['documenti_contabilita_articoli_name'] . ' - ' . $articolo['documenti_contabilita_articoli_descrizione']), 0, 90); ?></Descrizione>
