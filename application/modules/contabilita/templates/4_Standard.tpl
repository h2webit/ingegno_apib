                ...
                <div class="big_table">
                    <div class="container">
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive-sm table_articoli">
                                <table class="table table-cleared">
                                    ...
                                    ?>
                                        ...
                                        <?php
                                        if (!empty($documento['documenti_contabilita_imponibile_iva_json']) && $mostra_totali_senza_iva == DB_BOOL_FALSE) :
                            ...
                            <?php if(
                                (!empty($documento['documenti_contabilita_stampa_note_generiche']) && $documento['documenti_contabilita_stampa_note_generiche'] == DB_BOOL_TRUE )
                                && (!empty($documento['documenti_contabilita_note_generiche']) && $documento['documenti_contabilita_note_generiche'] != '')
                                ) : ?>
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="titolo_note"><?php e('Note'); ?></div>
                                    </div>
                                    <div class="col-sm-12">
                                        <?php echo $documento['documenti_contabilita_note_generiche']; ?>
                                    </div>
                                </div>
                            <?php endif; ?>
                            ...
                            <?php if (!empty($settings['documenti_contabilita_settings_frase_pie_pagina'])): ?>
                                <div class="informativa">
                                    <p>
                                        <?php echo $settings['documenti_contabilita_settings_frase_pie_pagina']; ?>
                                    </p>
                                </div>
                            <?php endif; ?>
