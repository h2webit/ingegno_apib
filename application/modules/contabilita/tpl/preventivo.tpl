                                    ...
                                    <tr class="t_rows">
                                        ...
                                        <td class="right"><?php echo $valuta[$documento['documenti_contabilita_valuta']]; ?>
                                            ...
                                            if ($articolo['documenti_contabilita_articoli_imponibile'] > 0) {
                                                ...
                                                if (!empty($articolo['documenti_contabilita_articoli_sconto']) && $articolo['documenti_contabilita_articoli_sconto'] > 0) {
                                                    $sconto = ($imponibile / 100) * $articolo['documenti_contabilita_articoli_sconto'];
                    ...
                    <?php if ($pagina == count($gruppi_articoli)) : ?>
                        ...
                        <div class="row payments">
                            <div class="col-md-4 bank">
                                <div class="banktext">
                                    <strong><?php echo ucfirst($documento['documenti_contabilita_template_pagamenti_nome']); ?></strong><br>
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                <strong>Data_____________________________________________</strong>
                            </div>
                            <div class="col-md-7">
                                <strong>Firma__________________________________________________________________</strong>
                            </div>
                        </div>
