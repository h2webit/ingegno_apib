...
!(function (t, e) {
    ...
    function W(t) {
        N(I({ putSortable: it, cloneEl: Q, targetEl: z, rootEl: q, oldIndex: J, oldDraggableIndex: et, newIndex: tt, newDraggableIndex: nt }, t));
    }
    var z,
        G,
        U,
    ...
    function Rt(t, e) {
        ...
        (this.nativeDraggable = !e.forceFallback && xt),
            ...
            e.supportPointer ? d(t, "pointerdown", this._onTapStart) : (d(t, "mousedown", this._onTapStart), d(t, "touchstart", this._onTapStart)),
        ...
        _showClone: function (t) {
            if ("clone" === t.lastPutMode) {
                if ($) {
                    ...
                    z.parentNode != q || this.options.group.revertClone ? (V ? q.insertBefore(Q, V) : q.appendChild(Q)) : q.insertBefore(Q, z),
                            ...
                            if (
                                ...
                                for (; se.length; ) {
                                    ...
                                    k(e, this.options.selectedClass, !1),
                                        se.shift(),
                                        N({ sortable: this.sortable, rootEl: this.sortable.el, name: "deselect", targetEl: e, originalEvt: t });
                                }
                        },
