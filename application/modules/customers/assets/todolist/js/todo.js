    ...
    if ($('#todo-lists')[0]) {
        ...
        $('body').on('click', '.add-tl-actions > a', function (e) {
            ...
            if (y == "save") {
                ...
                $.ajax({
                    method: 'post',
                    url: base_url + 'customers/todolist/create',
                    dataType: 'json',
                    data: {
        ...
        $('body').on('change', '.checkbox.media input[type="checkbox"]', function (e) {
            ...
            $.post(base_url + 'customers/todolist/edit/' + todoitemsId, { [token_name]: token_hash, todolist_deleted: todoitem.is(':checked') ? '1' : '0' });
        });
        ...
        $('body').on('click', '.js_remove_todo', function () {
            ...
            $.ajax({
                method: 'post',
                url: base_url + 'customers/todolist/delete/' + todoitemsId,
                dataType: 'json',
                data: {
                    [token_name]: token_hash
                },
