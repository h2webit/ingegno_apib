var CrmNotifier = {
    ...
    audio: null,
    played: false,
    enableUserSound: $("meta[name='enable-user-sounds']").attr("content"),
    ...
    fetch: function () {
        ...
        $.ajax({
            url: base_url + "core-notifications/main/dropdown_notification_list",
            dataType: "json",
            async: true,
            success: function (json) {
                ...
                $.each(json.data, function (index, notification) {
                    ...
                    if (notification.notifications_desktop_notified == "0") {
                        ...
                        notifier.showDesktopNotification(notification.notifications_id, {
                            title: notification.notifications_title,
                            message: notification.notifications_message,
                    ...
                    if (notification.notifications_read == "0" && notification.notifications_type == "5") {
                        notifier.readAndOpenModal(notification.notifications_id, {
                            title: notification.notifications_title,
                            message: notification.notifications_message,
                            link: notification.notifications_link,
                        });
                ...
                if (notifier.number > 0 && notifier.enableUserSound == "true") {
                    var baseSoundFolder = base_url_scripts + "script/js/";
                    console.log("user has notification sound enabled");
    ...
    showUnread: function (html) {
        ...
        if (this.number > 0) {
            $(".js_notification_number_label", this.listContainer).removeClass("hide");
        } else {
            $(".js_notification_number_label", this.listContainer).addClass("hide");
        }
    ...
    setRead: function (notificationId) {
        return $.ajax(base_url + "core-notifications/main/notify_read/" + (typeof notificationId === "undefined" ? "" : notificationId));
    },
    ...
    setDesktopNotified: function (notificationId) {
        ...
        return $.ajax(base_url + "core-notifications/main/notify_desktop_notified/" + (typeof notificationId === "undefined" ? "" : notificationId));
    },
