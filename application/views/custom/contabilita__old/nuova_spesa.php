...
<form class="formAjax" id="new_fattura" action="<?php echo base_url('custom/spese/create_spesa'); ?>">
        ...
        <div class="col-md-8">
            <div class="row" style="background-color:#e0eaf0;">
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            <label style="min-width:80px" >Numero documento: </label>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <div class="input-group js_form_datepicker date ">
                                ...
                                if (!empty($spesa[$key])) : ?><?php echo date('d-m-Y', strtotime($spesa[$key])); ?><?php endif; ?>"
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            >
                                                ...
                                                <option value="Contanti" <?php if ($scadenza['spese_scadenze_saldato_con'] == 'Contanti'): ?> selectefd="selected"<?php endif; ?>>
                                                    Contanti
                                                </option>
                                                <option<?php if ($scadenza['spese_scadenze_saldato_con'] == 'Bonifico bancario'): ?> selectefd="selected"<?php endif; ?>>
                                                    Bonifico bancario
                                                </option>
                                                <option<?php if ($scadenza['spese_scadenze_saldato_con'] == 'Assegno'): ?> selectefd="selected"<?php endif; ?>>
                                                    Assegno
                                                </option>
                                                <option<?php if ($scadenza['spese_scadenze_saldato_con'] == 'RiBA'): ?> selectefd="selected"<?php endif; ?>>
                                                    RiBA
                                                </option>
                                                <option<?php if ($scadenza['spese_scadenze_saldato_con'] == 'Sepa RID'): ?> selectefd="selected"<?php endif; ?>>
                                                    Sepa RID
                                                </option>
                                            </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group js_form_datepicker date  field_68">
                                                <input type="text" class="form-control"
                                                       ...
                                                       value="<?php echo date('d/m/Y', strtotime($scadenza['spese_scadenze_data_saldo'])); ?>"
                                                >
    ...
    $(document).ready(function () {
        ...
        $("#search_cliente").autocomplete({
            source: function (request, response) {
                $.ajax({
                    method: 'post',
                    url: base_url + "custom/documents/autocomplete/fw_providers",
                    dataType: "json",
                    data: {
                        search: request.term
                    },
...
//
    ...
    function calculateTotals(spesa_id) {
        ...
        if (mode == 'articoli') {
            ...
            totale -= ritenuta;
            $('[name="spese_imponibile"]').val(totale.toFixed(2));
        } else { //solo totali
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            var myDropzone = new Dropzone(document.querySelector('.my_dropzone'), {
                url: "<?php echo base_url('custom/spese/addFile'); ?>",
            ...
            $('#new_fattura [type="submit"]').click(function(e){
