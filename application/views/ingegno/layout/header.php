...
<nav class="navbar navbar-static-top">
    <div class="nav_container_custom">
        <div class="left">
            ...
            <a href="#" class="sidebar-toggle header-toggle hidden-sm hidden-md hidden-lg" data-toggle="push-menu"
                role="button">
            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                    ...
                    <?php if ($pending_processes > 0): ?>
                        <li class="navbar-circle pending_processes" id="pending_processes"
                            style="margin-left:16px;margin-right:0px;font-size:15px">
