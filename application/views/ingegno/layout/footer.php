...
<footer class="main-footer no-print">
    ...
    <div class="center_side pull-left hidden-xs">
        ...
        Copyright &copy; 2015-
        <?php echo date('Y'); ?> - All right reserved - Built with <a href="https://openbuilder.net" target="_blank"
            class="footer_link"><strong>Open Builder</strong></a> - By <a href="https://h2web.it" target="_blank"
...
<script
    src='<?php echo base_url_scripts("script/global/plugins/jquery-ui-touch-punch/jquery.ui.touch-punch.min.js?v=" . VERSION) ?>'></script>
